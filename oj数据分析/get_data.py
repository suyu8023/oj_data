...
class crawl_data():
    ...
    #SDUTOJ做题，训练计划
    def sdutoj_make_url(self, src):

        #数据库提取id

    #对给定的比赛网址，修正成json数据网址
    def vj_make_url(self, src):
    ...
    #牛客网
    def newcoder_make_url(self, src):
        href = 'https://ac.nowcoder.com/acm/contest/profile/' + id

    #AtCoder
    def AtCoder_make_url(self, src):
